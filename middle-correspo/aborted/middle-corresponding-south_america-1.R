...
for ( i in 1:len.csv.list ) {
  ...
  dat <- read.csv( csv_list[i] )
  num.list <- c( which(dat$area=="East Asia"), which(dat$correspondance==0) )
  num.non.corresponding.author.ea <- num.list[duplicated( num.list )]
  ...
  if( len.non.corresponding.author.ea > 0 ){
    ...
    new.list <- cbind(
      ...
      dat[num.non.corresponding.author.ea,]$affiliation,
      dat[num.non.corresponding.author.ea,]$nation,
      dat[num.non.corresponding.author.ea,]$area
    )
...
if( !is.null(list.non.corresponding.author.ea.all) ){
  colnames( list.non.corresponding.author.ea.all ) <- c( "volume_issue", "id", "title", "author", "status", "correspondance", "affiliation", "nation", "area" )
}
...
if( !is.null(list.corresponding.author.for.non.crsp.ea) ){
  colnames( list.corresponding.author.for.non.crsp.ea ) <- c( "volume_issue", "id", "title", "author", "status", "correspondance", "affiliation", "nation", "area" )
}
...
if( !is.null(list.non.crsp.author.ea.crsp.other) ){
  colnames( list.non.crsp.author.ea.crsp.other ) <- c( "volume_issue", "id", "title", "author", "status", "correspondance", "affiliation", "nation", "area" )
}
...
if( !is.null(list.non.crsp.author.ea.crsp.non.native) ){
  colnames( list.non.crsp.author.ea.crsp.non.native ) <- c( "volume_issue", "id", "title", "author", "status", "correspondance", "affiliation", "nation", "area" )
}
...
if( !is.null(list.crsp.author.ea.crsp.non.native) ){
  colnames( list.crsp.author.ea.crsp.non.native ) <- c( "volume_issue", "id", "title", "author", "status", "correspondance", "affiliation", "nation", "area" )
}
...
for ( i in 1:len.csv.list ) {
  ...
  dat <- read.csv( csv_list[i] )
  num.list <- c( which(dat$area=="East Asia"), which(dat$correspondance==1) )
  ...
  if( len.corresponding.author.ea > 0 ){
    ...
    new.list <- cbind(
      ...
      dat[num.corresponding.author.ea,]$affiliation,
      dat[num.corresponding.author.ea,]$nation,
      dat[num.corresponding.author.ea,]$area
    )
...
if( !is.null(list.corresponding.author.ea) ){
  colnames( list.corresponding.author.ea ) <- c( "volume_issue", "id", "title", "author", "status", "correspondance", "affiliation", "nation", "area" )
}
...
if( !is.null(list.non.correspo.other.crsp.ea) ){
  colnames( list.non.correspo.other.crsp.ea ) <- c( "volume_issue", "id", "title", "author", "status", "correspondance", "affiliation", "nation", "area" )
}
...
for ( i in 1:len.csv.list ) {
  ...
  if( length(num.new.list) > 0 ){
    ...
    for ( j in 1:length(num.new.list) ) {
      ...
      # nations match
      nums.nums <- which( new.new.list$area == "East Asia" )
...
if( !is.null(list.crsp.only.ea) ){
  colnames( list.crsp.only.ea ) <- c( "volume_issue", "id", "title", "author", "status", "correspondance", "affiliation", "nation", "area" )
}
...
if( !is.null(list.non.correspo.other.crsp.only.ea) ){
  colnames( list.non.correspo.other.crsp.only.ea ) <- c( "volume_issue", "id", "title", "author", "status", "correspondance", "affiliation", "nation", "area" )
}
